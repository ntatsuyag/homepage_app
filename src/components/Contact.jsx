            ...
            <div className='text-gray-800'>
                ...
                <div className='bg-gray-200'>
                    <div className='ml-2 text-xl'>
                        ...
                        <a href="mailto:nityamanishi@gmail.com" className='underline'>E-mail:nityamanishi@gmail.com</a>
                        </div>
                        <div className='flex'>
                            {/* GitHub Icon */}
                            ...
                            <a href="https://github.com/ntatsuyag" className='underline'>GitHub</a>
                        </div>
                        <div className='flex'>
                            {/* Twitter Icon */}
                            ...
                            <a href="https://twitter.com/yama_nisshii" className='underline'>Twitter</a>
                        </div>                    
                    </div>
                </div>
            </div>
